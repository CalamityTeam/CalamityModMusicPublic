...
namespace CalamityModMusic.Tiles
{
	public class SignusMusicbox : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeables.SignusMusicbox>());
		}
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.showItemIcon2 = ModContent.ItemType<Items.Placeables.SignusMusicbox>();
        }
    }
}